...
const SheetContent = React.forwardRef(
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-8 top-6  outline-none">
          <IoClose className="text-3xl hover:opacity-75 transition-opacity duration-150 ease-in-out" />
